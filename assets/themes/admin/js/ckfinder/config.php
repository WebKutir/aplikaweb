...
*/
$baseUrl = 'http://localhost/foo/myupload/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/foo/myupload/';
...
$config['plugin_imageresize']['mediumThumb'] = '150x150';
$config['plugin_imageresize']['largeThumb'] = '200x200';
